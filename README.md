...
`tools/list` at `https://gateway.pipeworx.io/performance-review/mcp` returns the tools in the table
...
```json
{
  "mcpServers": {
    "performance-review": {
      "command": "npx",
      "args": ["-y", "@pipeworx/mcp-performance-review"]
    }
  }
}
```
...
```bash
npx -y @pipeworx/mcp-performance-review
```
